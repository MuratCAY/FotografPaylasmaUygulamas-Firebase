...
class HaberSinifiAdapter(val postList: ArrayList<Post>): RecyclerView.Adapter<HaberSinifiAdapter.PostHolder>()  {
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        Picasso.get().load(postList[position].gorselUrl).into(holder.itemView.recycler_row_image)
    }
